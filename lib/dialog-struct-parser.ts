...
function jsonToStructProto(json: Record<string, any>) {
...
export function jsonValueToProto(value: any) {
	const valueProto: Record<string, any> = {}
...
export function structProtoToJson(proto: Record<string, any>) {
